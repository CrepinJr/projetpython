...
# #TABLE_ETUDIANTS
# tableau = ttk.Treeview(root, columns = (1, 2, 3, 4, 5), rows = (1, 2, 3), height = 2, show = "headings")
# tableau.place(x=150,y=150, height=150)

# #Entete
# tableau.heading(1, text = "NOM")
# tableau.heading(2, text = "MATIERE")
# tableau.heading(3, text = "EVALUATION")
# tableau.heading(4, text = "NOTES")
...
# #dimentions pour lignes
# tableau.rows(1,width = 150)
# tableau.rows(2,width = 150)
# tableau.rows(3,width = 150)
